...
- Common datasets for fine-tuning
    ...
    * [sharegpt4, A high quality dataset generated by using GPT-4 to complete refined ShareGPT](https://huggingface.co/datasets/openchat/openchat_sharegpt4_dataset)
    ...
    * [WizardLM V2](https://huggingface.co/datasets/WizardLM/WizardLM_evol_instruct_V2_196k)
    * [SlimPajama: cleaned up RedPajama](https://huggingface.co/datasets/cerebras/SlimPajama-627B)
